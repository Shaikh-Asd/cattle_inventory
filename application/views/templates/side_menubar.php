    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if (in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
        <li class="treeview" id="mainOrdersNav">
          ...
          <ul class="treeview-menu">
            <?php if (in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
              <li id="manageOrdersNav"><a href="<?php echo base_url('MedicineController/add_transaction_form') ?>"><i class="fa fa-circle-o"></i> Outward Medicines</a></li>
            <?php endif; ?>

            <?php if (in_array('createOrder', $user_permission)): ?>
              <li id="addOrderNav"><a href="<?php echo base_url('MedicineController/view_transactions') ?>"><i class="fa fa-circle-o"></i> Manage Outward Medicines</a></li>
            <?php endif; ?>

            <?php if (in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
              <li id="manageOrdersNav"><a href="<?php echo base_url('MedicineController/customer_medicine_view') ?>"><i class="fa fa-circle-o"></i> Manage Medicines</a></li>
            <?php endif; ?>
          </ul>
        </li>
      <?php endif; ?>
